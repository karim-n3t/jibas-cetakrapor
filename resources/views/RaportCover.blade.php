@extends('layouts.app', ['activePage' => 'Raport', 'titlePage' => __('Cetak Cover Raport')])
          ...
          <table class="table-borderless">
            <tbody style="font-size:large; line-height:2;">
              <tr>
                ...
                <td class="pl-3">
                  @php
                    $arrbiodata = array('Nama Peserta Didik (Lengkap)','Nomor Induk/NISN','Tempat, Tanggal Lahir','Jenis Kelamin','Agama','Status dalam
                    Keluarga','Anak ke','Alamat Peserta Didik','Nomor Telepon Rumah','Sekolah Asal','Diterima di sekolah ini','Di
                    kelas','Pada tanggal','Nama Orang Tua','a. Ayah','b. Ibu','Alamat Orang Tua','Nomor Telepon Rumah','Pekerjaan Orang
                    Tua','a. Ayah','b. Ibu','Nama Wali Peserta Didik','Alamat Wali Peserta Didik','Nomor Telepon Rumah','Pekerjaan Wali
                    Peserta Didik')
                  @endphp
                  @foreach ($arrbiodata as $bio)
                    {{ $bio }}<br>
                  @endforeach
                </td>
                <td class="pl-5">
      ...
      <div class="card-body print" id="printMe">
        ...
        <div class="table-responsive">
          <table class="table">
            <thead>
              @php
                $tabel = array('No','Nama Lengkap','NIS/NISN','Tempat, Tanggal Lahir','Gender','Agama','Status','Anak ke','Alamat siswa','HP Siswa','Asal Sekolah','Tanggal masuk','Nama Ayah','Nama Ibu','Alamat Ortu','Handphone','Pekerjaan Ayah','Pekerjaan Ibu','Wali')
              @endphp
              <tr>
